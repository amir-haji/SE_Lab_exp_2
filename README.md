...
پاسخ:
در صورتی که اصول SOLID در کد رعایت شده‌بودند، از ایجاد تغییرات با شماره‌ی ۲ تا ۷ و ۹ معاف بودیم، و تنها نیاز به ایجاد دو تغییر در کلاس PaymentServices که (که در نسخه جدید به اسم PaymentFactory است چون از الگوی factory method استفاده شده است.) و ایجاد یک تغییر برای تشخیص حالت سفارش با موبایل در فایل Main وجود دارد.
